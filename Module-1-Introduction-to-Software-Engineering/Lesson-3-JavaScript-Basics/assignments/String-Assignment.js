...
const greeting= "Hello Friend"
 let Newstring= greeting.slice(5)
 console.log(Newstring)
// 3. Using 5 or more of the followng words, create a template literal that makes a legible sentence.
...
const word22 = "also";
const word23 = "like"; 
console.log(`${word1} ${word4} ${word11} ${word20} ${word19} ${word15}`)
// 4. Given the string of your full name get your initials.
let myname ="Garry lee Garnett"
console.log(myname[0]+myname[10])
